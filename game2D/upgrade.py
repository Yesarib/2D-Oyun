...
class Upgrade:
    ...
    def create_items(self):
        ...
        for item, index in enumerate(range(self.attribute_number)):
            full_witdh = self.display_surface.get_size()[0]
            increment = full_witdh // self.attribute_number
...
class Item:
    ...
    def display_names(self, surface, name, cost, selected):
        color = txt_color_selected if selected else txt_color
    ...
    def trigger(self, player):
        ...
        if player.exp >= player.upgrade_cost[upgrade_attribute] and player.stats[upgrade_attribute] < player.max_stats[upgrade_attribute]:
            ...
            player.upgrade_cost[upgrade_attribute] *= 1.7
    ...
    def display(self, surface, selection_number, name, value, max_value, cost):
        if self.index == selection_number:
            pygame.draw.rect(surface, upgrade_bg_color, self.rect)
